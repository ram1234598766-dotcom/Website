    ...
    <div className="flex flex-col gap-10 w-full max-w-4xl mx-auto animate-in fade-in duration-500 pb-12">
      <div className="flex flex-col items-center text-center gap-6 py-12 border-b border-white/10">
        ...
        <p className="text-xl text-slate-400 max-w-2xl leading-relaxed">
          At VantaOS, we believe your data belongs to <span className="text-indigo-400 font-bold">you</span>. Our architecture ensures absolute data sovereignty, transparent model training, and zero-trust execution.
        </p>
      </div>
      ...
      <div className="space-y-8 text-slate-300 leading-relaxed">
        ...
        <section className="bg-white/5 p-8 rounded-2xl shadow-sm border border-white/10">
          ...
          <p>
            We enforce full transparency in all data-handling processes. When your models are trained on the VantaOS cloud:
          </p>
          <ul className="list-disc list-inside mt-4 space-y-2 text-slate-400 ml-4">
