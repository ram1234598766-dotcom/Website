    ...
    <div className="flex flex-col gap-8 w-full max-w-5xl mx-auto animate-in fade-in duration-500 pb-16">
      <div className="text-center space-y-4 py-8">
        <div className="inline-flex items-center gap-2 px-3 py-1 bg-indigo-50 border border-indigo-200 rounded-full text-indigo-700 text-xs font-bold tracking-widest uppercase">
          <Zap className="w-4 h-4" /> Novalith Core Architecture
        </div>
        <h2 className="text-4xl font-extrabold tracking-tight text-slate-900">Foundational AI Model</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm hover:shadow-md transition-shadow">
          ...
          <h3 className="text-xl font-bold text-slate-800 mb-2">MoE (Mixture of Experts)</h3>
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm hover:shadow-md transition-shadow">
          ...
          <h3 className="text-xl font-bold text-slate-800 mb-2">Omni-Modal Ingestion</h3>
          <p className="text-slate-600 text-sm leading-relaxed">
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm hover:shadow-md transition-shadow">
          ...
          <h3 className="text-xl font-bold text-slate-800 mb-2">Mesh-Native Distillation</h3>
          <p className="text-slate-600 text-sm leading-relaxed">
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm hover:shadow-md transition-shadow">
          ...
          <h3 className="text-xl font-bold text-slate-800 mb-2">Continuous Pre-training</h3>
          <p className="text-slate-600 text-sm leading-relaxed">
            Unlike static weights, the Novalith Foundation Model supports asynchronous continuous pre-training. Data streams from the global mesh subtly adjust parameter gradients without requiring massive catastrophic forgetting restarts.
          </p>
        </div>
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm hover:shadow-md transition-shadow">
          ...
          <h3 className="text-xl font-bold text-slate-800 mb-2">Homomorphic Weight Safety</h3>
          <p className="text-slate-600 text-sm leading-relaxed">
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm hover:shadow-md transition-shadow">
          ...
          <h3 className="text-xl font-bold text-slate-800 mb-2">Pluggable Speculative Decoding</h3>
          <p className="text-slate-600 text-sm leading-relaxed">
      ...
      <div className="mt-8 bg-slate-900 rounded-2xl p-8 border border-slate-800 text-white">
        ...
        <p className="text-slate-300 leading-relaxed mb-6">
          The true power of the Novalith foundational model lies in its open-source DNA. We utilize the MIT License for the inference engine and the Apache 2.0 license for the foundational weights. 
        ...
        <div className="bg-black/50 p-4 rounded-xl border border-slate-700 font-mono text-sm text-emerald-400">
          <p>$ novalith pull foundation-v1 --quantize int4</p>
          <p>$ novalith attach-lora ./finance-expert.safetensors</p>
          <p>$ novalith serve --port 8080</p>
        </div>
      </div>
    </div>
  );
