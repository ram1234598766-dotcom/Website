      ...
      {!isForgotPassword ? (
        <>
          <button 
            ...
            className="w-full bg-white/5 hover:bg-white/10 text-white font-semibold py-3 px-4 rounded-xl transition-all mb-6 border border-white/10 flex items-center justify-center gap-3"
          >
          ...
          <form onSubmit={async (e) => {
            ...
            <input type="email" name="email" placeholder="Email address" className="w-full px-4 py-3 bg-black/20 border border-white/10 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500/50 text-white placeholder-slate-500" required />
            <input type="password" name="password" placeholder="Password" className="w-full px-4 py-3 bg-black/20 border border-white/10 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500/50 text-white placeholder-slate-500" required />
            ...
            {authError && authError.includes('Email not confirmed') && (
               ...
               }} className="w-full bg-white/5 hover:bg-white/10 text-white font-semibold py-2.5 px-4 rounded-xl transition-all text-sm border border-white/10">
                  Resend Verification Email
               </button>
            )}

            <button type="submit" className="w-full bg-indigo-600/90 hover:bg-indigo-500 text-white font-semibold py-3 px-4 rounded-xl transition-all shadow-[0_0_15px_rgba(79,70,229,0.3)] mt-2">
