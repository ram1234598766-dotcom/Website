        ...
        >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
            ...
            <div className="vanta-card overflow-hidden flex flex-col">
              ...
              <div className="p-7 space-y-3.5 text-sm text-[#9499ad] leading-relaxed flex-1">
                <p><strong className="text-white">Choose a provider</strong> — open ⚙️ Settings in Omni-AI. Pick <strong className="text-white">Local Ollama</strong> (models on your machine), or a cloud provider like <strong className="text-white">OpenRouter</strong>, <strong className="text-white">Gemini</strong>, or <strong className="text-white">OpenAI</strong>.</p>
                <p><strong className="text-white">Connect Ollama</strong> — run <code className="text-emerald-400 font-mono text-xs bg-black/30 px-1.5 py-0.5 rounded">set OLLAMA_ORIGINS=* && ollama serve</code> (Windows) or <code className="text-emerald-400 font-mono text-xs bg-black/30 px-1.5 py-0.5 rounded">OLLAMA_ORIGINS=* ollama serve</code> (Mac/Linux), then refresh in Omni-AI.</p>
                ...
                <p><strong className="text-white">Offline mode</strong> — Omni-AI requires a connected provider. Without one, you'll see a clear message instead of offline answers.</p>
              </div>
            </div>
